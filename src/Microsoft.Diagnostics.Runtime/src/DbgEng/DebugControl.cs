...
namespace Microsoft.Diagnostics.Runtime.DbgEng
{
    ...
    internal readonly unsafe struct IDebugControlVTable
    {
        ...
        public readonly delegate*<IntPtr /*self*/, out uint /*cls*/, out DEBUG_CLASS_QUALIFIER /*qualifier*/, HResult> GetDebuggeeType;
        ...
        public readonly delegate*<IntPtr /*self*/, HResult> IsPointer64Bit;
        ...
        public readonly delegate*<IntPtr /*self*/, out IMAGE_FILE_MACHINE /*Type*/, HResult> GetEffectiveProcessorType;
        ...
        public readonly delegate*<IntPtr /*self*/, int /*options*/, HResult> AddEngineOptions;
        ...
        public readonly delegate*<IntPtr /*self*/, int /*flags*/, uint /*timeout*/, HResult> WaitForEvent;
        ...
        public readonly delegate*<IntPtr /*self*/, out DEBUG_FORMAT /*format*/, HResult> GetDumpFormatFlags;
