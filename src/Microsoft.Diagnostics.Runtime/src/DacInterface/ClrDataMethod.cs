...
namespace Microsoft.Diagnostics.Runtime.DacInterface
{
    public sealed unsafe class ClrDataMethod : CallableCOMWrapper
    {
        ...
        public ILToNativeMap[]? GetILToNativeMap()
        {
            ...
            hr = VTable.GetILAddressMap(Self, needed, out needed, map);
    ...
    internal readonly unsafe struct IXCLRDataMethodInstanceVTable
    {
        ...
        public readonly delegate* unmanaged[Stdcall]<IntPtr, uint, out uint, [Out][MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 0)] ILToNativeMap[]?, HResult> GetILAddressMap;
