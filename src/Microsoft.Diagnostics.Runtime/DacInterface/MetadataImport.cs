...
namespace Microsoft.Diagnostics.Runtime.DacInterface
{
    internal sealed unsafe class MetadataImport : CallableCOMWrapper
    {
        ...
        public bool GetMethodAttributes(int token, out MethodAttributes attrs)
        {
            HResult hr = VTable.GetMethodProps(Self, token, out _, null, 0, out _, out attrs, out _, out _, out _, out _);
            return hr;
        }
        ...
        public HResult GetTypeDefProperties(int token, out string? name, out TypeAttributes attributes, out int mdParent)
        {
            ...
            string nameResult = new('\0', needed);
            ...
            nameResult = nameResult.TrimEnd((char)0);
