...
namespace Microsoft.Diagnostics.Runtime
{
    ...
    public readonly struct ClrObject : IClrValue, IEquatable<ClrObject>
    {
        ...
        private IAbstractTypeHelpers Helpers => GetTypeOrThrow().Helpers;
        ...
        {
            IAbstractTypeHelpers? helpers = Helpers;
            if (helpers is null)
                return default;
        ...
        public string? ReadStringField(string fieldName, int maxLength = 4096)
        {
            ...
            if (!dataReader.ReadPointer(address, out TargetPointer strPtr))
                return null;
